//-----------------------------------------------------------------------------
// Torque Game Engine 
// Copyright (C) BraveTree Productions
...
datablock PlayerData(PlayerBody)
{
   ...
   maxInv[Crossbow] = 1;
   maxInv[Rifle] = 1;
   maxInv[AssaultRifleAmmo] = 50;
   maxInv[AssaultRifle] = 1;
};
...
function Armor::onCollision(%this,%obj,%col)
{
   ...
   if((%this.className $= WheeledVehicleData || %this.className $= FlyingVehicleData ||%this.className $= HoverVehicleData || %this.className $= JetBikeData)
