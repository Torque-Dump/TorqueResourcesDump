var GG = function () {
    return {
        init: function () {
            ...
            $("#product-features .tab-list a, #product-media .tab-list a, #related-products .tab-list a, .section-tabs-list a").each(function () {
                $(this).mouseup(function () {
            ...
            $(".tab-box .tab-list:not(.no-link) li a").click(function (b) {
                ...
                if ($(a).children("ul.jcarousel-skin-tango")) {
            ...
            $(".section-tabs-list a").each(function () {
                $(this).click(function (d) {
                    d.preventDefault();
                    var e = $(this).parents(".section-tabs-list").find("a.current");
                    var c = $(e.attr("href"));
                    var b = $(this);
                    var a = $($(this).attr("href"));
                    e.removeClass("current");
            ...
            $("input:not([title])[type=text], input[type=password], textarea, select").each(function () {
                $(this).focus(function () {
