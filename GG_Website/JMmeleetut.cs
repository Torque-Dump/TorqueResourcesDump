//
// All this is Josh Moore's.
// Cleaned up the tut and added some missing brackets and such...
// enjoy...J...
//
...
//
//Alt Tutorial at http://www.freewebz.com/t2theforce/meleeTutorial.zip
...
// At the end of Player::Player() around line 814 add:
...
//!!!!!This next step Doesn't match SDK 1.5.2!!!!!!!!
//
//the numbers are different. Here they don't have the decimal or the "f"
//on the end of them

//make sure you add them for 1.5.2 or you will get an error on compile
...
// in ShapeBase::packUpdate(NetConnection..., replace:
//line 2876
...
// further down, line 2928 replace:
...
// now in void ShapeBase::unpackUpdate(NetConnection..., after:
...
//add after void ShapeBase::setSkinName(const..., before consoleMethod
//line 3446
...
// in ShapeBaseData::preload, BEFORE
...
//----1------------
//Place the sword.dts and sword.png in its own "Sword" folder in ../data/shapes/
//-----------------


//----2------------
//Copy the appropriate player files and dsq's into the ../data/shapes/player folder
//-----------------


//----3------------
// In game.cs at line 49, add: 
...
//----4-----------------------------------------------------------------
// In game.cs at approx. line 333 change:
...
***NOTE: I've been recieving invalid packet errors on mission load
         when I change this. Sometimes it works fine, other times it
...
//In player.cs you have to add the hook into your inventory
//
//At approx. line 674 add:
...
//----6------------------------------------------
//add this to the end of you sword.cs file if you want to pick up the sword when you place it in the mission
...
That should be all.
Thanks to Josh Moore for making a cool resource like this.